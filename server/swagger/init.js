...
const doc = {
  info: {
    version: '1.0.0',
    title: 'ContiIRA Developer API',
    description: 'API endpoints that enable programmatic reading, writing, and updating of your ContiIRA instance. UI supplied by Swagger.io.',
  },
